...
class Config(metaclass=Singleton):
    ...
    def __init__(self, yaml_file=default_yaml_file):
        ...
        print(os.environ)  # Add this line to print environment variables
    ...
    def _init_with_config_files_and_env(self, configs: dict, yaml_file):
        ...
        for _yaml_file in [yaml_file, self.key_yaml_file]:
            ...
            with open(_yaml_file, "r", encoding="utf-8") as file:
                ...
                # Replace "${{ secrets.OPENAI_API_KEY }}" with the actual API key from environment variable
                for k, v in yaml_data.items():
                    if isinstance(v, str):
                        v = v.replace("${{ secrets.OPENAI_API_KEY }}", os.environ.get("OPENAI_API_KEY", ""))
                        os.environ[k] = v
                    configs[k] = v
